...
| 12 | **Alipay Trust** | **Wrong name.** The actual spec Alipay published is the "Agentic Commerce Trust Protocol (ACTP)." "Alipay Trust" is a colloquial shorthand that may not map to any Alipay product. | Rename to "Agentic Commerce Trust Protocol (ACTP)"; track as "emerging rail" since we have no working integration |

...
**DPA status:** SettleGrid has executed (or will execute — see `docs/legal/stripe-dpa-status.md` for the current state) Stripe's standard Data Processing Addendum.

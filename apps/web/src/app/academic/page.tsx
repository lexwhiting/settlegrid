...
const BENEFITS = [
  ...
  },
  {
    ...
    description: 'Advanced analytics, consumer insights, anomaly detection, CSV analytics export, audit logs, and more.',
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" aria-hidden="true">
  ...
  {
    title: 'MCP + REST + Multiple Protocols',
    description: 'Use tools via MCP, REST, or any of the supported agent payment protocols.',
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" aria-hidden="true">

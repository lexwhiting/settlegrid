    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 flex items-center justify-center px-6 py-24">
        <div className="max-w-lg w-full">
          <div className="rounded-xl border border-gray-200 dark:border-[#2E3148] bg-white dark:bg-[#1A1D2E] p-10 text-center shadow-sm">
            ...
            <h1 className="text-2xl font-bold text-indigo dark:text-gray-100 mb-3">Tool Marketplace</h1>
            <p className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed mb-2">Coming Soon</p>
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-3">
                <div className="flex flex-col sm:flex-row gap-3">
                  ...
                  <input
                    ...
                    required
                    disabled={loading}
                    className="flex-1 h-10 rounded-md border border-gray-300 dark:border-[#2E3148] bg-white dark:bg-[#1A1D2E] px-3 py-2 text-sm placeholder:text-gray-500 dark:text-gray-400 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand focus-visible:ring-offset-2 disabled:opacity-50"
                  />
                  <button
                    type="submit"
                    disabled={loading}

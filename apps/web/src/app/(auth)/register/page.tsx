      ...
      <div className="min-h-screen flex items-center justify-center px-4 bg-cloud dark:bg-[#0F1117]">
        <div className="w-full max-w-md">
          <div className="bg-white dark:bg-[#1A1D2E] rounded-xl shadow-lg border border-gray-200 dark:border-[#2E3148] p-8 text-center">
            ...
            <h2 className="text-xl font-bold text-indigo dark:text-gray-100 mb-2">
              Check your email
            </h2>
            ...
            <Link
              href="/login"
              className="inline-block mt-6 text-sm font-medium text-brand hover:text-brand-dark dark:text-brand-light"
            >
              Back to sign in
            </Link>
          </div>
        ...
        <div className="bg-white dark:bg-[#1A1D2E] rounded-xl shadow-lg border border-gray-200 dark:border-[#2E3148] p-8">
          ...
          <div className="space-y-3 mb-6">
            <button
              ...
              className="w-full flex items-center justify-center gap-3 rounded-lg border border-gray-300 dark:border-[#2E3148] bg-white dark:bg-[#252836] px-4 py-2.5 text-sm font-medium text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-[#2E3148] transition-colors"
            >
          ...
          <form onSubmit={handleSignUp} className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full rounded-lg border border-gray-300 dark:border-[#2E3148] bg-white dark:bg-[#252836] px-3 py-2 text-sm text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-brand focus:border-transparent"
          ...
          <p className="mt-6 text-center text-sm text-gray-500 dark:text-gray-400">
            ...
            <Link href="/login" className="font-medium text-brand hover:text-brand-dark dark:text-brand-light">
              Sign in
            </Link>
          </p>
        </div>

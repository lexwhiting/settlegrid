  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="flex flex-col items-center text-center">
        ...
        <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">Documentation Error</h2>
        <p className="text-sm text-gray-500 dark:text-gray-400 mb-4 max-w-md" role="alert">
          Something went wrong loading the documentation. This is usually temporary.
        </p>

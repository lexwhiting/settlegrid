...
import { PasteUrlInput } from '@/components/marketing/paste-url-input'
  ...
  return (
    <div className="dark min-h-screen flex flex-col bg-[#0C0E14] text-gray-100">
      ...
      <main className="flex-1">
        ...
        {/* ================================================================ */}
        {/*  1b. Paste. Price. Publish. — 60-second onboarding section       */}
        {/* ================================================================ */}
        <section className="px-6 py-16 border-b border-gray-200 dark:border-[#2A2D3E] bg-gradient-to-b from-[#0C0E14] to-[#111320]">
          <RevealSection>
            <div className="max-w-3xl mx-auto text-center">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-brand/10 border border-brand/20 text-brand text-xs font-semibold mb-5">
                <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" aria-hidden="true">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 13.5l10.5-11.25L12 10.5h8.25L9.75 21.75 12 13.5H3.75z" />
                </svg>
                60 seconds to revenue
              </div>
              <h2 className="text-3xl sm:text-4xl font-bold font-display text-gray-100 mb-4">
                Paste. Price. Publish.
              </h2>
              <p className="text-lg text-gray-400 mb-8 max-w-xl mx-auto">
                Paste any API endpoint — we auto-detect the service type, suggest pricing based on market data, and generate a billed proxy URL. No SDK. No code changes. No Stripe setup.
              </p>

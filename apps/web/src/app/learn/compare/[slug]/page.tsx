...
const multiComparisons: Record<string, MultiComparisonData> = {
  'mcp-billing-platforms-2026': {
    ...
    settlegridPros: [
      ...
      'Broadest protocol support (10 protocols vs 1\u20132 for competitors)',
...
const comparisons: Record<string, ComparisonData> = {
  ...
  'vs-mcpize': {
    ...
    features: [
      ...
      { feature: 'Protocol support', settlegrid: '10 protocols', competitor: 'MCP only' },
  ...
  'vs-paid-ai': {
    ...
    features: [
      ...
      { feature: 'Protocol support', settlegrid: '10 protocols', competitor: 'MCP' },
  ...
  'vs-moesif': {
    ...
    features: [
      ...
      { feature: 'Protocol support', settlegrid: '10 protocols', competitor: 'REST only' },
  ...
  'vs-stripe-metronome': {
    ...
    features: [
      ...
      { feature: 'Protocol support', settlegrid: '10 protocols (MCP, x402, AP2, A2A, etc.)', competitor: 'Stripe ecosystem only' },
  ...
  'vs-orb': {
    ...
    features: [
      ...
      { feature: 'AI tool discovery', settlegrid: 'Built-in marketplace + Discovery API', competitor: 'No' },
      { feature: 'Protocol support', settlegrid: '10 protocols (MCP, x402, AP2, A2A, etc.)', competitor: 'REST webhooks' },
      { feature: 'Free tier', settlegrid: '50K ops/mo, $0 forever', competitor: 'No (enterprise pricing)' },
  ...
  'vs-lago': {
    ...
    features: [
      ...
      { feature: 'AI tool discovery', settlegrid: 'Built-in marketplace + Discovery API', competitor: 'No' },
      { feature: 'Protocol support', settlegrid: '10 protocols (MCP, x402, AP2, A2A, etc.)', competitor: 'REST API events' },

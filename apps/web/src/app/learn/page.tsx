...
const SECTIONS: SectionCard[] = [
  ...
  },
  {
    ...
    description:
      'Install the SettleGrid GitHub App to auto-discover MCP tools in your repositories. Push code, get listed, start earning. Zero configuration required.',
    href: '/learn/github-app',
    badge: 'Zero code',
    icon: (
  ...
  },
  {
    ...
    description:
      'Use paid SettleGrid tools natively in popular AI agent frameworks. Step-by-step integration guides for smolagents (Hugging Face), LangChain, CrewAI, and n8n with code examples in TypeScript and Python.',

...
// No manual reconciliation. No delayed settlements.`}
            ...
            <div>
              ...
              <p className="text-gray-300 leading-relaxed mb-3">
                SettleGrid tracks 14 agent payment protocols out of the box: 9 brokered by the Smart Proxy,
                2 detection-adapter-only, and 3 tracked as emerging upstream specs. Your tool works with any
                of them without protocol-specific code:
              </p>
              <div className="grid grid-cols-3 sm:grid-cols-5 gap-2 mb-4">
                {['MCP', 'x402', 'Stripe MPP', 'AP2', 'ACP', 'UCP', 'Visa TAP', 'Mastercard VI', 'Circle Nanopayments', 'L402', 'KYAPay', 'ACTP', 'EMVCo agent payments', 'DRAIN'].map((p) => (

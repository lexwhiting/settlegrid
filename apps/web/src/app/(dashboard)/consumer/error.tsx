...
export default function ConsumerError({
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[400px] text-center px-4">
      ...
      <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">Consumer Dashboard Error</h2>
      <p className="text-sm text-gray-500 dark:text-gray-400 mb-4 max-w-md" role="alert">
        Something went wrong loading your consumer dashboard. This is usually temporary.
      </p>
      <div className="flex items-center gap-3">
        ...
        <a href="/docs" className="px-4 py-2 text-sm font-medium text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-200 transition-colors">
          View Docs
        </a>
      </div>

...
export default function AnalyticsError({
  ...
  return (
    <div className="text-center py-12">
      <h2 className="text-xl font-bold text-indigo dark:text-gray-100 mb-2">Analytics Error</h2>
      <p className="text-gray-600 dark:text-gray-400 mb-4" role="alert">
        Something went wrong loading your usage analytics. Please try again.
      </p>
      <button
        onClick={reset}

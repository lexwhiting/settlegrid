...
export default function FraudError({
  ...
  return (
    <div className="text-center py-12">
      <h2 className="text-xl font-bold text-indigo dark:text-gray-100 mb-2">Fraud Detection Error</h2>
      <p className="text-gray-600 dark:text-gray-400 mb-4" role="alert">
        Something went wrong loading fraud detection data. Please try again.
      </p>
      <button
        onClick={reset}

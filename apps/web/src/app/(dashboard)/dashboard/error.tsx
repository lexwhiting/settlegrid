...
export default function DashboardError({
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[400px] text-center px-4">
      ...
      <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">Dashboard Error</h2>
      <p className="text-sm text-gray-500 dark:text-gray-400 mb-4 max-w-md" role="alert">
        Something went wrong loading the dashboard overview. This is usually temporary.
      </p>

...
export default function AuditLogError({
  ...
  return (
    <div className="text-center py-12">
      <h2 className="text-xl font-bold text-indigo mb-2">Audit Log Error</h2>
      <p className="text-gray-600 mb-4" role="alert">Something went wrong loading the audit log.</p>
      <button
        onClick={reset}

    ...
    <section className="py-24 lg:py-32">
      <div className="w-full max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-6 lg:gap-8">
          ...
          <div className="md:col-span-2 rounded-lg border border-border bg-card p-6 lg:p-8 flex flex-col gap-5 transition-all duration-200 hover:border-muted-foreground/50 hover:-translate-y-0.5">

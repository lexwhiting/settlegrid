...
// P5.4 — Template-of-the-Week posts are auto-generated by
// scripts/template-of-the-week.ts. Drafts ship with `published: false`
// so they're filtered out of public surfaces until the founder rewrites
// and flips the flag.
import { TOTW_POSTS } from './blog-bodies/totw/registered'
...
export const BLOG_POSTS: BlogPost[] = [
  ...
  // P5.4 — Auto-generated TOTW drafts merged here. Initially empty;
  // the weekly cron appends entries via registered.ts. Each entry
  // ships as `published: false`, so it stays out of public surfaces
  // until the founder rewrites + flips the flag.
  ...TOTW_POSTS,
]
